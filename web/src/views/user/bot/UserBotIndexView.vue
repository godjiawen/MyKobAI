            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-header">
                        <span style="font-size: 130%; vertical-align: middle;">我的Bot</span>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr v-for="bot in bots" :key="bot.id">
                                    <td style="vertical-align: middle;">{{ bot.title }}</td>
                                    <td style="vertical-align: middle;">{{ bot.createtime }}</td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">创建Bot</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"  @click="refresh_bots"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            <label for="add-bot-title" class="form-label">名称</label>
...
export default {
    ...
    setup() {
        const aceVersion = ace.version || "1.33.1";
        ace.config.set(
            "basePath",
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app6201.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app6201.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app6201.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app6201.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
