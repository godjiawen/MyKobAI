<template>
  <div class="friends-page">
    ...
    <FriendInviteDialog
      ...
      :room-name="friendStore.inviteDialogRoomName"
      :map-id="friendStore.inviteDialogMapId"
      :round-seconds="friendStore.inviteDialogRoundSeconds"
      :allow-spectator="friendStore.inviteDialogAllowSpectator"
      ...
      @update:roomName="friendStore.setInviteDialogRoomName($event)"
      @update:mapId="friendStore.setInviteDialogMapId($event)"
      @update:roundSeconds="friendStore.setInviteDialogRoundSeconds($event)"
      @update:allowSpectator="friendStore.setInviteDialogAllowSpectator($event)"
